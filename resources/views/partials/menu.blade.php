<div class="sidebar">
    <nav class="sidebar-nav">
        ...
        <ul class="nav">
            ...
            @endcan
            @can('non_crude_access')
                <li class="nav-item">
                    <a href="{{ route("admin.non-crudes.index") }}" class="nav-link {{ request()->is('admin/non-crudes') || request()->is('admin/non-crudes/*') ? 'active' : '' }}">
                        <i class="fa-fw fas fa-cogs nav-icon">

                        </i>
                        {{ trans('cruds.nonCrude.title') }}
                    </a>
                </li>
            @endcan
            <li class="nav-item">
